...
<table id="miTabla" class="table table-sm table-striped table-hover mt-4" >
    <thead >
        <tr>
            <th scope="col" class="col-sm-2">Solicitud</th>
            <th scope="col" class="col-sm-2">Usuario</th>
            <th scope="col" class="col-sm-4">Partida</th>
            <th scope="col" class="col-sm-3">Proceso</th>
            <th scope="col" class="col-sm-3">Fecha de Solicitud</th>
            <th scope="col" class="col-sm-2">Tipo</th>
            <th scope="col" class="col-sm-4">Descripción</th>
            <th scope="col" class="col-sm-1">Espacio</th>
